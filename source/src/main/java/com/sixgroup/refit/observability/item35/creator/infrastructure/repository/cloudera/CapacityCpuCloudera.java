...
public class CapacityCpuCloudera implements CapacityCpuRepository {
    ...
    public List<Capacity> findByCapacityCpu(String dateFrom, String dateTo) {
        ...
        urlBuilder.addQueryParameter(QUERY, apiClouderaProperties.getCpu().getSelectCpu());
        ...
        urlBuilder.addQueryParameter(DESIRED_ROLLUP, apiClouderaProperties.getCpu().getDesiredRollup());
