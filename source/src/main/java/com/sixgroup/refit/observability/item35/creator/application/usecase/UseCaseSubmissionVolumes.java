...
public class UseCaseSubmissionVolumes implements ItemTypeStrategy {
    ...
    public File execute(ItemCommandDTO itemCommand, Headers headers) {
        ...
        try {
            ...
            final Iterator<RecordStatus> recordStatus = recordStatusService.iterateRecordStatus(dateFrom, dateTo);
            if (!recordStatus.hasNext()) {
            ...
            //Saved information
            file = writeFileSubmissionVolumes.writeFileStreaming(recordStatus, itemCommand, fileName);
