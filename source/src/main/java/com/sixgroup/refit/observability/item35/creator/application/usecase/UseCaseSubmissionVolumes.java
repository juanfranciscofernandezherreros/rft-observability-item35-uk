...
public class UseCaseSubmissionVolumes implements ItemTypeStrategy {
    ...
    public File execute(ItemCommandDTO itemCommand, Headers headers) {
        ...
        try {
            ...
            stateService.setError(StateRequest.builder().fileName(FileUtils.getFileName(itemCommand)).itemType(ITEM35).errorDescription("Error to generate file submission volumes: " + e.getMessage()).build());
        }
        return file;
    }
